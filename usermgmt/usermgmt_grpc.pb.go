...
type UserManagementClient interface {
	CreateNewUser(ctx context.Context, in *NewUser, opts ...grpc.CallOption) (*NewUserResponse, error)
}
...
func (c *userManagementClient) CreateNewUser(ctx context.Context, in *NewUser, opts ...grpc.CallOption) (*NewUserResponse, error) {
...
type UserManagementServer interface {
	CreateNewUser(context.Context, *NewUser) (*NewUserResponse, error)
...
func (UnimplementedUserManagementServer) CreateNewUser(context.Context, *NewUser) (*NewUserResponse, error) {
